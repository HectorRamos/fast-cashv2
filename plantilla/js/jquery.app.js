...
*/
   ...
   jQuery('.open-left').click(function(){
       ...
       var i = $(this).find('i');
       i.attr('class', i.hasClass('ion-navicon-round') ? 'ion-ios7-arrow-forward' : i.attr('data-original'));
   });
    ...
    Sidemenu.prototype.menuItemClick = function(e) {
       if(!$("#wrapper").hasClass("enlarged")){
        ...
        if(!$(this).hasClass("subdrop")) {
          ...
          $("#sidebar-menu .pull-right i").removeClass("md-keyboard-arrow-up").addClass("md-keyboard-arrow-down");
          
          // open our new menu and add the open class
          $(this).next("ul").slideDown(350);
          $(this).addClass("subdrop");
          $(".pull-right i",$(this).parents(".has_sub:last")).removeClass("md-keyboard-arrow-down").addClass("md-keyboard-arrow-up");
          $(".pull-right i",$(this).siblings("ul")).removeClass("md-keyboard-arrow-up").addClass("md-keyboard-arrow-down");
        }else if($(this).hasClass("subdrop")) {
          $(this).removeClass("subdrop");
          $(this).next("ul").slideUp(350);
          $(".pull-right i",$(this).parent()).removeClass("md-keyboard-arrow-up").addClass("md-keyboard-arrow-down");
        }
      } 
    },
