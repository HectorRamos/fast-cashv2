          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <div class="table-title">
                <div class="row">
                  <div class="col-md-5">
                    <h3 class="panel-title">Reporte general de créditos saldados</h3>                 
                  </div>
                </div>
              </div>
            </div>
            <div class="row" style="padding-left: 50px; padding-right: 50px;">
                <div class="col-md-12 text-center">
                    <form class="form-inline" id="buscrPorFecha" method="get" action="<?= base_url() ?>Reportes/CreditosSaldados/2">
                      <div class="margn">
              ...
              <div class="margn">
                <table class="table">
                  ...
                  <div class="pull-right">
                    <a title='Ver en PDF' href="<?= base_url() ?>Reportes/ReporteSaldadosPDF/<?php echo $parametro?>?fechaInicial=<?php echo $fechaInicial;?>&&fechaFinal=<?php echo $fechaFinal;?>" target="_blank" type='button' class='btn btn-danger block waves-effect waves-light m-b-5'><i class='fa fa-file fa-lg'></i> Ver en PDF </a> 
                    <a title='Aprobar Solicitud'  href="<?= base_url() ?>Reportes/ReporteSaldadosEXCEL/<?php echo $parametro?>?fechaInicial=<?php echo $fechaInicial;?>&&fechaFinal=<?php echo $fechaFinal;?>" target="_blank" type='button' class='btn btn-success block waves-effect waves-light m-b-5'><i class='fa fa-file fa-lg'></i> Excel </a>
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                      ...
                                      <div class="col-md-4 col-md-pull-2 text-center">
                                        ...
                                        <p><strong>REPORTE DE CRÉDITOS PENDIENTES</strong></p>
                                      </div>
