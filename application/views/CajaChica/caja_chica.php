        ...
        <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <?php 
              ...
              {
            ?>
              <form method="post" action="<?= base_url() ?>CajaChica/AperturarCajaChica" id="formAperturar" autocomplete="off">
                <div class="margn">
                  ...
                  <div class="margn">
                    <div class="row">
                      <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control DateTime" id="fecha_apertura" name="fecha_apertura" placeholder="Fecha apertura de caja chica" data-mask="9999/99/99">
                      </div>
                      <div class="form-group col-md-6">
              ...
              <?php
                ...
                <form id="DProcesoCC2" method="post" action="<?= base_url() ?>CajaChica/GuardarProcesoCC" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                            ...
                            <input type="text"  class="form-control DateTime" id="fecha_proceso" name="fecha_proceso" placeholder="Fecha en la que se realiza el proceso" data-mask="9999/99/99">
                            <input type="hidden" value="<?= $caja->idCajaC ?>" class="form-control" id="id_cc" name="id_cc" placeholder="Fecha de recibido del prestamo">
                ...
                <form method="post" action="<?= base_url() ?>CajaChica/CerrarCajaChica/">
                      <input type="hidden" value="<?= $fechaActual?>" class="form-control" id="fecha_cc" name="fecha_cc" placeholder="Fecha de recibido del prestamo">
                      <input type="hidden" value="<?= $caja->idCajaC ?>" class="form-control" id="id_cc" name="id_cc" placeholder="Fecha de recibido del prestamo">
                      <input type="hidden" value="<?= $caja->saldo ?>" class="form-control" id="saldo_cc" name="saldo_cc" placeholder="Fecha de recibido del prestamo">
