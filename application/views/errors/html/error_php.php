...
<body>
<div class="terminal">
  <h1><span class="errorcode">Se ha encontrado un error PHP.</span></h1>
    <p class="output"><font class="enla">Severity:</font> <?php echo $severity; ?></p>
	<p class="output"><font class="enla">Message:</font> <?php echo $message; ?></p>
	<p class="output"><font class="enla">Filename:</font> <?php echo $filepath; ?></p>
	<p class="output"><font class="enla">Line Number:</font> <?php echo $line; ?></p>
